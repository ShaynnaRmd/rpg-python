...
def sound_simpsons():
    ...
    sound1 = pygame.mixer.Sound("/Users/shay/Desktop/CODE/Python/Projet RPG/Thème Simpson.ogg")
    sound1.play(-1)
...
def start():
    ...
    if Data.current_position == Data.R9:
        print("FELICITATIONS ! Tu as réussi à atteindre la chambre de Bart et à échapper à Homer !\n\n              FIN DU JEU")
